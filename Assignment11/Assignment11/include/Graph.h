...
class Graph {
    public:
        ...
        void shortestDistance(std::string start, std::string end);
        void roadTrip(std::string start);
    protected:
    private:
        ...
        void setUnvisited();
        int findNumberCitiesInDistrict(vertex* city);
        bool vertexInPath(vertex* city, queueVertex* pathV);
